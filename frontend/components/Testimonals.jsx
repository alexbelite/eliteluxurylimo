...
export default function Testimonals() {
  const testimonals = [
    ...
    {
      name: "Sarah Piper",
      role: "President Superior",
      // date: "1 month ago",
      text: `My family and I have used Elite Luxury Limousine
          multiple occasions.  Drivers are always on time actually 
          always arrive early, courteous, and patient. Vehicles
          are clean and safe. I can't imagine calling any 
          other company after experiencing the professionalism
          of the Elite Luxury Limousine team.
        `,
      rating: 5,
    },
  ];
  return (
    ...
    <div className="grid overflow-x-auto max-sm:flex  max-sm:px-5 grid-cols-6 gap-2 px-1">
