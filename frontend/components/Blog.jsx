...
export default function Blog() {
  const images = [
    {
      ...
      image:
        "https://res.cloudinary.com/dxvf93ovn/image/upload/v1710723377/alexlimoimg/airtransport_pkxsdl.jpg",
    ...
    },
    {
      id: "corporate",
      image:
        "https://res.cloudinary.com/dxvf93ovn/image/upload/v1710717113/alexlimoimg/corporate_meeting_gil4fa.jpg",
    ...
    },
    {
      id: "tours",
      image:
        "https://res.cloudinary.com/dxvf93ovn/image/upload/v1710717301/alexlimoimg/private_excursion_evymmt.jpg",
    ...
    },
    {
      id: "events",
      image:
        "https://res.cloudinary.com/dxvf93ovn/image/upload/v1710717116/alexlimoimg/events_pic_03142024_four_edp67y.jpg",
  ...
  return (
    <div
      id="services"
      className="scroll-mt-20 grid grid-cols-1 grid-flow-row max-lg:gap-y-3"
    >
