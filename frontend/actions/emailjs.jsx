  ...
  emailjs
    .send(
      ...
      "template_27rrkit",
      {
        ...
        from_airport_address:
          data.serviceDetail === "from" ? data.airportAddress : "",
        to_airport: data.serviceDetail === "to" ? data.airportName : "",
        to_airport_address:
          data.serviceDetail === "to" ? data.airportAddressB : "",
...
export async function sendCreateAccountData(data) {
  return emailjs.send(
    "service_neww707",
    "template_z7utfyk",
    {
...
export async function sendTripDataToAdmin(data) {
  return emailjs.send("service_neww707", "template_wh5tkhz", data, {
    publicKey: "sM37gZ0m6VgAVXPw9",
  });
}
