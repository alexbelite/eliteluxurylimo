                ...
                <div class="col-lg-12">
                    <div class="ui raised segment">
                        ...
                        <div style="text-align:center">
                           ...
                           @if($data->image_1)
                           <a href="{{url($data->image_1)}}"  target="_blank"><img src="{{url($data->image_1)}}"  width="200px" height="200px" /></a>
                           @endif
                              @if($data->image_2)
                           <a href="{{url($data->image_2)}}"  target="_blank"><img src="{{url($data->image_2)}}"  width="200px" height="200px" /></a>
                           @endif
                              @if($data->image_3)
                           <a href="{{url($data->image_3)}}"  target="_blank"><img src="{{url($data->image_3)}}"  width="200px" height="200px" /></a>
                           @endif
