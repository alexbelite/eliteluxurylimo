...
class PushNotification  {
    ...
    public static  function sendFcmNotify($user_devices, $message, $dictionary = '', $type = '' , $sound = '')
    {
        ...
        (
            'priority'             => "high",
            'data'         => array( "title"=>"Chitrakoot Vikas Samiti - Sec 9", "body" =>$message,'sound' => 'default','type'=>$type,'dictionary' => $dictionary),
            'notification'         => array( "title"=>"Chitrakoot Vikas Samiti - Sec 9","message"=>$message, "body" =>$message,'sound' => 'default','type'=>$type,'dictionary' => $dictionary),
        ); 
